const locale_en = {
    ...
    errorMsgBorderRadiusNotAllowed: 'Border radius is only allowed with background color or full border',
    errorMsgBorderRadiusOnlyOnSamePage: 'Border radius is only allowed if element is always on same page',
    ...
    errorMsgPlusVersionRequired: 'Requires commercial PLUS version',
    ...
    plusFeatureInfo: 'Requires commercial <a href="https://www.reportbro.com/license/index" target="_blank" rel="noreferrer">PLUS version</a>',
    plusFeatureInfoNestedParameter: 'Nested parameter requires commercial <a href="https://www.reportbro.com/license/index" target="_blank" rel="noreferrer">PLUS version</a>',
